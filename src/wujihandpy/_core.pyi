...
class Finger:
    ...
    def read_joint_position_unchecked(self) -> None:
        ...
    @typing.overload
    def trigger_transmission(self) -> None:
        ...
    @typing.overload
    def trigger_transmission(self) -> None:
        ...
...
class Hand:
    ...
    def write_joint_control_word_unchecked(self, value_array: typing.Annotated[numpy.typing.ArrayLike, numpy.uint16]) -> None:
        ...
    def write_joint_pdo_interval(self, value: numpy.uint32) -> None:
        ...
    async def write_joint_pdo_interval_async(self, value: numpy.uint32) -> None:
        ...
    def write_joint_pdo_interval_unchecked(self, value: numpy.uint32) -> None:
        ...
    @typing.overload
    def write_joint_sin_level(self, value: numpy.uint16) -> None:
        ...
