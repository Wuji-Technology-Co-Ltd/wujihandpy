...
public:
    ...
    void run() {
        ...
        hand_.write<data::joint::ControlMode>(4);
        hand_.write<data::hand::GlobalTpdoId>(1);
        hand_.write<data::hand::JointPdoInterval>(950);
        hand_.write<data::hand::PdoEnabled>(1);
        hand_.write<data::joint::ControlWord>(1);

        hand_.finger(0).write<data::joint::ControlWord>(5);
        for (int i = 1; i < 5; i++)
            hand_.finger(i).joint(1).write<data::joint::ControlWord>(5);
        ...
        hand_.write<data::joint::ControlWord>(5);
