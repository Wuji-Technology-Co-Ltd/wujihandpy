...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        module_dir = ext_dir.parent.resolve()
        ...
        # Remove stash generated from pybind11_stubgen
        rmtree(ext_dir / "__pycache__", ignore_errors=True)


# with open("README.en-us.md", "r", encoding="utf-8") as file:
...
setup(
    ...
    long_description="",
    ext_modules=[CMakeExtension("wujihandpy")],
